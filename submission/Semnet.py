...
# Download NLTK resources only once (outside the function)
try:  # This whole block to prevent issues if these are not downloaded
    # In Semnet.py
    print("Importing Semnet module...")
    nltk.data.find('averaged_perceptron_tagger')
    nltk.data.find('wordnet')
    nltk.data.find('omw-1.4')

except LookupError: # Download if not there yet
